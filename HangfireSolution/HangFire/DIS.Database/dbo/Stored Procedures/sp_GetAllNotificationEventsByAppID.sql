...
BEGIN
	...
	SELECT t.EventCode,ev.EventKey, el.LevelName, t.SubjectTemplate, t.BodyTemplate, t.AppID as PriorityAppID, t.PriorityApiId
		...
		INNER JOIN NotificationLevelsByApplication apple on apple.LevelId = t.LevelID 
